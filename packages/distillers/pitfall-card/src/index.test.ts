...
describe("pitfall-card distiller", () => {
  ...
  test("skips pitfalls without valid evidence refs", async () => {
    const plugin = factory();
          ...
          return {
            ...
            provider: {
              ...
              async complete() {
                return {
                  content:
                    '[{"problem":"Wrong API usage","root_cause":"Used deprecated API","solution":"Use the new endpoint","prevention":"Check docs first","category":"api","confidence":0.9,"evidence_refs":[{"message_id":"missing","excerpt":"wrong API"}]},{"problem":"No evidence","root_cause":"LLM omitted evidence","solution":"Skip it","prevention":"Require evidence refs","category":"quality","confidence":0.8}]',
                  tokens: { input: 10, output: 10 },
                };
              },
            },

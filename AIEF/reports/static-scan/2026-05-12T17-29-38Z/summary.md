...
- Report: /Users/loong/workspace/code/github/ai/loamlog/AIEF/reports/static-scan/2026-05-12T17-29-38Z
- Profile: fast
- Top N: 5
- Findings: 81
- Selected Top N: 5
...
1. [low] biome packages/evaluation-harness/src/index.ts:2:8 - All these imports are only used as types.
2. [low] biome packages/evaluation-harness/src/metrics.ts:1:8 - All these imports are only used as types.
3. [low] biome packages/pipeline/src/index.test.ts:3:34 - Several of these imports are unused.
4. [low] biome packages/pipeline/src/index.test.ts:152:40 - This parameter is unused.
5. [low] biome packages/pipeline/src/index.ts:63:33 - Forbidden non-null assertion.

## Rerun Comparison

- Previous run: `2026-05-12T17-11-13Z`
- Fixed: 0
- Still present: 5

...
| [signal-gate.md](../openspec/signal-gate.md) | `NormalizedSession` 与资产萃取器之间的全局信号分级门规格 / Boundary spec for the global Signal Gate between `NormalizedSession` and asset distillers | 活跃 / Active |

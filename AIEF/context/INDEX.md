...
| [representative-asset-distillers.md](../openspec/representative-asset-distillers.md) | 代表性 AI 协作资产萃取器与插件底座边界：`idea-seed`、`practice-pitfall`、`decision-rationale`、`follow-up-work-item` / Boundary spec for representative AI collaboration asset distillers and plugin substrate | 活跃 / Active |
